                ...
                */        
                var DiceFace = function(descr) {
                   ...
                   // this.imageData = {}; 
                    ...
                    //this.debugImage();
                    var grayImag = SURF.grayImage(this.imageData);                        
                    this.keyPoints = SURF.surfDetDes(grayImag);
                ...
                this.detect = function(image) {
                    ...
                    for (i =0; i< 6; i++) {
                        if (keyPoints.length > 0) {                            
                            ...
                            matches = SURF.getMatches(diceFaces[i].keyPoints,keyPoints);
                            ...
                            if (matches.length >= 6) {
                                ...
                                for (j=0; j < matches.length; j++) {
                                    ...
                                    points2D.push(matches[j][1]);
                                    points3D.push(diceFaces[i].get3DCounterpart(matches[j][1]));
                                }
                    ...
                    if( points2D.length >= 4) {
                        ...
                        SURF.drawIPoints(debugCanvas.getContext("2d"),points2D,1);
                        // TODO #8

            ...
            function () {
                ...
                this.setIntrinsics = function (parameters) {
                     ...
                     */
                     var near = 0.1;
                     var far = 2000;
                     var left = - near * parameters[2] / parameters[0];
                     var right =  near * (canvas.width - parameters[2]) / parameters[0];
                     var bot = - near * parameters[5] / parameters[4];
                     var top = near * (sourceHeight - parameters[5]) / parameters[4];

                    
                    camera3d = new THREE.FrustumCamera(left, right, bot,top,near,far) ;
                ...
                this.setExtrinsics = function (markers) {
                    ...
                    for ( i = 0; i < markers.length; i++) {
                        if ( markers[i].id === sceneId ) {
                            var R = markers[i].pose.rotation;
                            var T = markers[i].pose.position;
                            ...
                            camera3d.setRotationFromMatrix(inv);
                            camera3d.position.x = inv.elements[12];
                            camera3d.position.y = inv.elements[13];
                            camera3d.position.z = inv.elements[14];
